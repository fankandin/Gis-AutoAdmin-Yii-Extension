...
return array(
	'Y (Latitude)' => 'Y (Широта)',
	'X (Longitude)' => 'X (Долгота)',
	'The parameter "defaultValue" is set incorrectly for the field {fieldName}' => 'Некорректно задан параметр defaultValue для поля {fieldName}',
	'Indicate on the map' => 'Выбрать на карте',
	'SRID' => 'SRID',
